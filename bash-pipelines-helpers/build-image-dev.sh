...
docker tag ucl-team-simulator:tmp ucl-team-simulator:dev-$latest_commit_hash-$docker_sha
git tag -a dev-$latest_commit_hash-$docker_sha -m "Tag for commit $latest_commit_hash with Docker image $docker_sha"
git push --tags

docker save ucl-team-simulator:dev-$latest_commit_hash-$docker_sha -o ucl-team-simulator-dev-$latest_commit_hash-$docker_sha.tar